...
st.set_page_config(page_title="TT STAR v17.1", page_icon="🏓", layout="wide")
...
with t2:
    ...
    if ratings:
        ...
        kWin = colA.number_input("Kurz A", 1.01, 20.0, 1.85)
...
with t4:
    ...
    if up and st.button("✅ NAHRÁT DATA"):
        ...
        save_data(st.session_state.data); st.success("Data obnovena!"); st.rerun()
